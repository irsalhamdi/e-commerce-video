...
func (at *authTest) signupOK(t *testing.T) {
	...
	exp := got
	exp.Name = "Irsal Hamdi"
	exp.Email = "irsalhamdi@test.com"
	exp.Role = "USER"
...
func (at *authTest) loginOK(t *testing.T) {
	if err := Login(at.Server, "irsalhamdi@test.com", "testpass"); err != nil {
		t.Fatalf("login failed: %v", err)
	}
}

func (at *authTest) loginWrongPass(t *testing.T) {
	if err := Login(at.Server, "irsalhamdi@test.com", "wrongpass"); err == nil {
